...
public:
    ...
    ConfigIni(std::string filename, std::string delimiter = "=", std::string comment = "#");
    ConfigIni();
    ...
    friend std::ostream& operator<<(std::ostream& os, const ConfigIni& cf);
    friend std::istream& operator>>(std::istream& is, ConfigIni& cf);
...
/* static */
template<class T>
std::string ConfigIni::T_as_string(const T& t)
{
...
/* static */
template<class T>
T ConfigIni::string_as_T(const std::string& s)
{
...
/* static */
template<>
inline std::string ConfigIni::string_as_T<std::string>(const std::string& s)
{
...
/* static */
template<>
inline bool ConfigIni::string_as_T<bool>(const std::string& s)
{
...
template<class T>
T ConfigIni::Read(const std::string& key) const
{
...
template<class T>
T ConfigIni::Read(const std::string& key, const T& value) const
{
...
template<class T>
bool ConfigIni::ReadInto(T& var, const std::string& key) const
{
...
template<class T>
bool ConfigIni::ReadInto(T& var, const std::string& key, const T& value) const
{
    // Get the value corresponding to key and store in var  
    // Return true if key is found  
...
template<class T>
void ConfigIni::Add(const std::string& in_key, const T& value)
{
